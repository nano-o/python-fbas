...
def run_command_with_config(config_content, fbas_file, command_args, expected_exit_code=0):
        ...
        fbas_content = """[
  {
    ...
    "quorumSet": {
      ...
      "validators": ["GDQWITFJLZ5HT6JCOXYEVV5VFD6FTLAKJAUDKHAV3HKYGVJWA2DPYSQV"]
        ...
        # Run command without --config-file (should auto-detect python-fbas.cfg)
        cmd = [
            sys.executable,
            "-m",
            "python_fbas.main",
