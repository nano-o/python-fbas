...
class TestPerUrlCaching:
    ...
    def test_different_urls_create_separate_cache_files(self):
        ...
        actual_files = os.listdir(cache_dir) if os.path.exists(cache_dir) else []
        
        assert os.path.exists(default_cache_path), f"Default cache file should exist at {default_cache_path}. Actual files: {actual_files}"
        assert os.path.exists(stellaratlas_cache_path), f"StellarAtlas cache file should exist at {stellaratlas_cache_path}. Actual files: {actual_files}"
